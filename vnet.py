...
class OutputTransition(nn.Module):
    def __init__(self, inChans, elu, nll):
        ...
        self.conv1 = nn.Conv3d(inChans, 1, kernel_size=5, padding=2)  # Output channels set to 1
        self.bn1 = ContBatchNorm3d(1)
        self.relu1 = ELUCons(elu, 1)

        # The softmax layer is not typically used for single-channel output
        # Usually, a sigmoid activation function is used for binary classification
...
class VNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.out_tr(out)
        # out16 = self.in_tr(x)
        # print("After in_tr:", out16.shape)
        # out32 = self.down_tr32(out16)
        # print("After down_tr32:", out32.shape)
        # out64 = self.down_tr64(out32)
        # print("After down_tr64:", out64.shape)
        # out128 = self.down_tr128(out64)
        # print("After down_tr128:", out128.shape)
        # out256 = self.down_tr256(out128)
        # print("After down_tr256:", out256.shape)
        # out = self.up_tr256(out256, out128)
        # print("After up_tr256:", out.shape)
        # out = self.up_tr128(out, out64)
        # print("After up_tr128:", out.shape)
        # out = self.up_tr64(out, out32)
        # print("After up_tr64:", out.shape)
        # out = self.up_tr32(out, out16)
        # print("After up_tr32:", out.shape)
        # out = self.out_tr(out)
        # print("After out_tr:", out.shape)
        return out
